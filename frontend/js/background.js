...
function createDiagonalLines() {
    ...
    for (let i = 0; i < 6; i++) {
      ...
      line1.className =
        "absolute w-full h-px bg-gradient-to-r from-transparent via-purple-400/20 to-transparent diagonal-line-1";
      ...
      line2.className =
        "absolute w-full h-px bg-gradient-to-r from-transparent via-blue-400/15 to-transparent diagonal-line-2";
  ...
  function createHorizontalLines() {
    ...
    for (let i = 0; i < 4; i++) {
      ...
      line.className =
        "absolute w-full h-px bg-gradient-to-r from-transparent via-purple-400/10 to-transparent slide-right";
  ...
  function createVerticalLines() {
    ...
    for (let i = 0; i < 4; i++) {
      const line = document.createElement("div");
      line.className =
        "absolute h-full w-px bg-gradient-to-b from-transparent via-blue-400/8 to-transparent slide-down";
  ...
  function createIntersectionPoints() {
    ...
    for (let i = 0; i < 20; i++) {
      ...
      dot.className =
        "absolute w-1 h-1 bg-purple-400/40 rounded-full pulse-dot";
